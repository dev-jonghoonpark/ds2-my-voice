...
> **학습 목적으로 만든 프로젝트입니다.** DeepSpeech2(2015)는 음성인식 파이프라인을 처음부터 직접 만들고 학습시켜 보려고 고른 구조이고, 성능을 위한 선택이 아닙니다. 실제로 받아쓰기를 쓰려는 목적이라면 **Whisper 계열** 모델을 쓰면 무난하게 잘 됩니다. 대규모 다국어 음성으로 학습되어 파인튜닝 없이도 한국어를 잘 받아쓰고, 필요하면 LoRA 같은 방법으로 내 목소리나 분야 용어에 맞출 수 있습니다.
